...
let MemberJoin__submitFormDone = false; 
	function MemberJoin__submitForm() {
...
<div class="section section-article-list px-2">
	<div class="container mx-auto">
		<form method="POST" action="doJoin" onsubmit="MemberJoin__submitForm(this); return false;">
			...
			<div class="form-control">
				<label class="label"> 로그인비밀번호확인</label>
			...
			<div class="form-control">
				...
				<input class="input input-bordered w-full" type="text" maxlength="30" name="nickname" placeholder="닉네임을 입력해주세요" />
			</div>
			<div class="form-control">
			...
			<div class="form-control">
				...
				<input class="input input-bordered w-full" type="tel" maxlength="50" name="email" placeholder="이메일을 입력해주세요" />
			</div>
